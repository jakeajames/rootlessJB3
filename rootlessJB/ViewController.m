...
//        _jailbreakButton.titleLabel.font = [UIFont systemFontOfSize:16 weight:UIFontWeightSemibold];
...
- (IBAction)jailbreak:(id)sender {
    ...
    if ((flags & CS_PLATFORM_BINARY)) {
        system_("/var/containers/Bundle/iosbinpack64/usr/bin/killall backboardd");
    } else {
        //---- tfp0 ----//
